...
| `DISPATCH_PAT` | Fine-grained GitHub PAT for `nw-paragliding/pnw-soaring` with **Actions: Read and write**. The deploy workflow injects it as the Worker secret `GH_DISPATCH_TOKEN`. |
